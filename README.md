...
function RayfieldLibrary:CreateWindow(Settings)
	...
	LoadingFrame.Title.Text = Settings.LoadingTitle or "CookieHub"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "Rayfield"
		...
		task.spawn(function()
			while true do
				...
				RayfieldLibrary:Notify({
					Title = "CookieHub",
					Content = "Hope you guys enjoying Cookie Hub!",
					Duration = 7,
					Image = 4370033185,
				})
			end
